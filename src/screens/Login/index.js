      ...
      <View style={styles.backGround}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <ImageBackground
            ...
            style={styles.pagenameBackGround}>
          ...
          <View style={{flex: 1, padding: 10, marginTop: 20}}>
            ...
            <TouchableOpacity
              ...
              <Text style={[styles.footerText, {alignSelf: 'center'}]}>
                Forgot password?
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.socialLoginOuter}>
            ...
            <TouchableOpacity
              ...
              <Image
                ...
                style={{width: 47, height: 47, marginLeft: 10}}
              />
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {
