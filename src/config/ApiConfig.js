...
export const BASE_URL = 'http://194.163.131.163/rich_ecom/public/api/';
export const PRODUCT_DES_URL =
  'http://194.163.131.163/rich_ecom/public/productDescription/';
export const PRODUCTS_URL =
  'http://194.163.131.163/rich_ecom/public/product-detail/';
export const BLOG_URL = 'http://194.163.131.163/rich_ecom/public/blogDetails/';
export const FAQ_URL = 'http://194.163.131.163/rich_ecom/public/faqDescription/';
